<!--
 * @Author: your name
 * @Date: 2020-10-22 12:02:30
 * @LastEditTime: 2021-01-16 21:05:00
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \web\06-vue基础+项目实战\shopleft\src\views\home\components\components\YouLikeDetail.vue
-->
<template>
	<div id="youLikeDetail">
		<div class="image">
			<img :src="likeItem.small_image" alt="" />
		</div>
		<p>{{likeItem.name}}</p>
		<span class="currentPrice">¥{{likeItem.price | moneyFormat}}</span>
		<span class="originPrice">¥{{likeItem.origin_price | moneyFormat}}</span>
		<div class="cartSvg" @click="addToCart(likeItem)">
			<svg
				t="1603335466747"
				class="icon"
